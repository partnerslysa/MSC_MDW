...
app.post('/upfile', upload.single('file'), async (req, res) => {
    ...
    const url = 'https://3799749-sb1.app.netsuite.com/core/media/media.nl?id=526659&c=3799749_SB1&h=7lP9gQ91BTppGg5ModPdsaYZzJ2P_sxtWzSbjMNyDnCeX2Y7&_xt=.txt';
    ...
    console.log('fileContent:'+fileContent);
      ...
      .then(() => {
        const rutaLocal = `ArchivosTXT/Archivo Prueba3.txt`;
        const fileBuffer = req.file.buffer;
        const fileContent = fileBuffer.toString();
        console.log('69.fileBuffer: '+fileBuffer);
        console.log('70.fileContent: '+fileContent);
        const remotePath = '/home/ec2-user/test/Archivo Prueba3.txt';
        ...
        console.log('Desconexión exitosa');
                ...
                //return sftp.end();
                res.status(200).json({ message: 'Archivo cargado con éxito.', content: fileContent });
      })
      .catch((err) => {
